<%-- 
    Document   : show
    Created on : 26 Jan, 2020, 11:29:20 AM
    Author     : Arpit mishra
--%>
...
<html>
    <head>
        ...
        <body>
        <center><h1>List of person</h1></center>
    ...
    <span style="float:left"><a href="show.jsp?start=<%=start - end%>" class="btn btn-primary <% if (start == 0) {
            out.println("disabled");}%>">Previous</a></span>
    <center>
         <%
     int pages = total/end + (total%end==0?0:1);
       ...
       {%>
        ...
        <span style="text-decoration: none; align-content: center " class="btn btn-dark"><a href="show.jsp?start=<%=end * i%>">Page <%=i + 1%> </a></span> 
        <%}
        %>
